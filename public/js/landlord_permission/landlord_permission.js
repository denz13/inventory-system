document.addEventListener('DOMContentLoaded', function() {
    ...
    function applySearch() {
        ...
        const landlordRows = Array.from(document.querySelectorAll('#landlordPermissionTable tbody tr.intro-x'));
        ...
        updateNoResultsMessage(searchTerm, visibleCount, landlordRows.length);
    }

    // Update no results message
    function updateNoResultsMessage(searchTerm, visibleCount, totalRows) {
        const tbody = document.querySelector('#landlordPermissionTable tbody');
            ...
            noDataRow.innerHTML = `
                <td colspan="11" class="text-center py-8">
                    <div class="text-slate-500">
                        ...
                        <div class="text-sm">No landlords match your search. Try a different search term.</div>
                    </div>
                </td>
            `;
